...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`text-white bg-primary1/20 h-[80px] px-3 w-full flex flex-col justify-start md:justify-center items-center absolute top-0 left-0 transition-all duration-500 z-[100]`}
      >
